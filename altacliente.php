					...
					<form name="alta" method="post"action="">  
						<fieldset id="registro">  
							<legend>Alta de un usuario</legend>   
								...
								<br /><label for="razonsocial">Razon social :</label><br /></td><td><input name="razonsocial" type="text" id="razonsocial" size="120" /></td>  				<br /><label for="domicilio">Domicilio </label><br /></td> <td><input name="domicilio" type="text" id="domicilio" size="120"></td>
