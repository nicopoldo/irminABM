				...
				<div class="principal">
					<form name="alta" method="post"action="">  
						<fieldset id="registro">  
							<legend>Alta de un usuario</legend>   
								<label for="dniocuit">DNI o CUIT :</label></td><br><td><input name="dniocuit" type="text" id="dniocuit" size="30" /></td>    
								<br /><label for="razonsocial">Razón social :</label><br /></td><td><input name="razonsocial" type="text" id="razonsocial" size="120" /></td>  				<br /><label for="domicilio">Domicilio </label><br /></td> <td><input name="domicilio" type="text" id="domicilio" size="120"></td>
								<br /><label for="email">E-mail </label><br /></td> <td><input name="email" type="text" id="email" size="120"></td> 
								<br />
								<br /><td class="submit"></td><td><input type="submit" value="Registrar" /></td>
						</fieldset>  
					</form>
				</div>
