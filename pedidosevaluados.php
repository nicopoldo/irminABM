		...
		<div class="contenido cf">
			...
			<section class="cf">
				...
				-->
					...
					<form name="formulario" method="post"action="resultadopedidosevaluados.php">  
						<fieldset id="registro">  
							<legend>Buscar pedidos evaluados</legend>   
								<label for="numero">Nro de pedido </label></td><br> <td><input name="numero" type="text" id="numero" size="20"></td><br><br>
