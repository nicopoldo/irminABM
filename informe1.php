					...
					<form name="alta" method="post"action="imagenes1.php">  
						<fieldset id="registro">  
							<legend>Informe</legend>   
								...
								<label for="resumen">Resumen </label></td> <br><td><textarea name="resumen" rows="10" cols="40" id="resumen" font="Times New Roman" Readonly>Se encontraron 3 imagenes con condiciones predisponentes</textarea></td><br><br> 
								<br />
