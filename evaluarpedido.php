				...
				<form name="evaluar" method="post"action="evaluarpedido.php">  
					<fieldset id="registro">  
						<legend>Registrar pedido de revision</legend>   
							<label for="conclucion">Conclucion: </label></td> <br><td><textarea name="conclucion" rows="10" cols="40" id="conclucion" font="Times New Roman" placeholder="Conclusion sobre la evaluacion del pedido"></textarea></td><br><br>
