		...
		<div class="contenido cf">
			...
			<section class="cf">
				<div class="principal">
					...
					<form name="modificar" method="post"action="dardebaja.php">  
						<fieldset id="modificacion">  
							<legend>Modificar un usuario</legend>   
								<label for="dniocuit">DNI o CUIT :</label></td><br><td><input name="dniocuit" type="text" id="dniocuit" size="30" /></td><br><br>
								<td class="submit"></td><td><input type="submit" value="Buscar" /></td>
						</fieldset>  
					</form>
					<!--En esta parte, supongo que el usuario hace una busqueda por DNI o CUIT, busca que exista, y recien ahi le ofrece la pagina de modificacion.
					-->
